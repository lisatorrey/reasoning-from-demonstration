"""Train and save an agent for Montezuma's Revenge."""
...
ATTEMPTS = 100000  # How long to train the agent
WINDOW = 10000  # Attempts averaged into each score report
FREQUENCY = 1000  # Attempts between score reports
